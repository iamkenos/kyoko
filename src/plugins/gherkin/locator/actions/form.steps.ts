...
When(
  ...
  async function(this: Context, locator: Locator) {
...
When(
  ...
  async function(this: Context, action: SetValueAction, value: string, locator: Locator) {
...
When(
  ...
  async function(this: Context, action: SetValueAction, locator: Locator, value: string) {
    await fn.fill(locator, value, action);
  }
);
...
When(
  ...
  async function(this: Context, action: SetValueAction, table: DataTable) {
...
When(
  ...
  async function(this: Context, action: SetValueAction, page: string, table: DataTable) {
    const values = table.raw().slice(1).map(([element, value, index]) =>
...
When(
  ...
  async function(this: Context, action: ToggleAction, locator: Locator) {
...
When(
  ...
  async function(this: Context, context: SelectOptionContext, option: string, locator: Locator) {
...
When(
  ...
  async function(this: Context, option: number, locator: Locator) {
...
When(
  ...
  async function(this: Context, locator: Locator, table: DataTable) {
...
When(
  ...
  async function(this: Context, filepath: string, locator: Locator) {
