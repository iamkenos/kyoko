...
When(
  ...
  async function(this: Context, action: ClickAction, locator: Locator, clickCount: number) {
...
When(
  ...
  async function(this: Context, source: Locator, target: Locator) {
...
When(
  ...
  async function(this: Context, locator: Locator, x: number, y: number) {
