...
Then(
  ...
  async function(this: Context, context: SelectOptionContext, expected: string, locator: Locator, not: boolean) {
...
Then(
  ...
  async function(this: Context, expected: number, locator: Locator, not: boolean) {
...
Then(
  ...
  async function(this: Context, locator: Locator, not: boolean, table: DataTable) {
