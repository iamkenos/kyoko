...
Then(
  ...
  async function(this: Context, locator: Locator, not: boolean, expected: HrefTargetContext) {
...
Then(
  ...
  async function(this: Context, locator: Locator, not: boolean, expected: string) {
...
Then(
  ...
  async function(this: Context, locator: Locator, not: boolean, scheme: HrefSchemeContext, expected: string) {
...
Then(
  ...
  async function(this: Context, locator: Locator, not: boolean, page: PageObject) {
