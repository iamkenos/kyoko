...
Then(
  ...
  async function(this: Context, not: boolean, page: PageObject) {
...
Then(
  ...
  async function(this: Context, context: string, not: boolean, filename: string) {
...
Then(
  ...
  async function(this: Context, not: boolean, context: MatchContext, title: string) {
...
Then(
  ...
  async function(this: Context, not: boolean, url: string) {
...
Then(
  ...
  async function(this: Context, not: boolean, value: number) {
...
Then(
  ...
  async function(this: Context, not: boolean, count: Count, value: number) {
